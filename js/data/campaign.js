(function initCampaign(window) {
  ...
  const campaign = [
    ...
    { id: '2-4', title: 'Split Loop Drill', hitsNeeded: 6, speed: 0.035, lives: 3, targets: 1, moveSpeed: 0.0062, reverse: false, mechanics: ['split'], text: 'Read the split tree: 1 big → 2 medium → 4 small, then reset and repeat.' },
