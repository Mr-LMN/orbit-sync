const campaign = [
  ...
  { id: "1-4", title: "Precision", hitsNeeded: 8, speed: 0.038, lives: 3, targets: 2, moveSpeed: 0.013, reverse: true, hasHeart: true, shrink: { startScale: 1, endScale: 0.78, distance: Math.PI * 2.8 }, text: "Two drifting zones tighten over time. Stay accurate." },
  { id: "1-5", title: "Fractals", hitsNeeded: 8, speed: 0.04, lives: 3, targets: 3, moveSpeed: 0.018, reverse: true, hasHeart: true, text: "Three zones. Stay sharp." },
