const campaign = [
  ...
  { id: "2-1", title: "Corner Precision", hitsNeeded: 5, speed: 0.03, lives: 3, targets: 1, moveSpeed: 0, reverse: false, mechanics: ["corner"], text: "Corner point is PERFECT. The target extends into the line for an OK hit." },
  { id: "2-2", title: "Dual Hit Circuit", hitsNeeded: 5, speed: 0.031, lives: 3, targets: 1, moveSpeed: 0, reverse: false, mechanics: ["dual"], text: "Each target has 2 linked nodes. Hit both before the lane passes." },
  { id: "2-3", title: "Split Reaction", hitsNeeded: 5, speed: 0.033, lives: 3, targets: 1, moveSpeed: 0, reverse: false, mechanics: ["split"], text: "Hit once to split. Hit again to shatter the fragments." },
  { id: "2-4", title: "Mixed Mechanics", hitsNeeded: 7, speed: 0.036, lives: 3, targets: 2, moveSpeed: 0.004, reverse: false, mechanics: ["corner", "dual", "split"], text: "Corners return with layered targets. Read fast and commit cleanly." },
  { id: "2-5", title: "Pressure Wave", hitsNeeded: 9, speed: 0.04, lives: 3, targets: 2, moveSpeed: 0.006, reverse: false, mechanics: ["corner", "dual", "split"], pressure: true, text: "Fast lanes, tight reads, mixed mechanics. Survive the spike." },
