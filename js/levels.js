const campaign = [
  ...
  { id: "2-1", title: "New Geometry", hitsNeeded: 4, speed: 0.032, lives: 3, targets: 1, moveSpeed: 0, reverse: false, text: "New shape. Same timing. Find your rhythm." },
  { id: "2-2", title: "Diamond Drift", hitsNeeded: 6, speed: 0.036, lives: 3, targets: 1, moveSpeed: 0.014, reverse: true, text: "Direction flips on every hit. Track the moving zone." },
  { id: "2-3", title: "The Trap", hitsNeeded: 6, speed: 0.038, lives: 3, targets: 1, moveSpeed: 0.008, reverse: true, hasPhantom: true, text: "The red dashed zone is a trap. Hit the white. Avoid the red." },
  { id: "2-4", title: "Split & Dodge", hitsNeeded: 8, speed: 0.04, lives: 3, targets: 2, moveSpeed: 0.01, reverse: true, hasPhantom: true, text: "Two real zones. One trap. Stay sharp." },
  { id: "2-5", title: "High Pressure", hitsNeeded: 10, speed: 0.044, lives: 3, targets: 2, moveSpeed: 0.018, reverse: true, hasPhantom: true, hasHeart: true, text: "Faster. More chaos. You know what to do." },
